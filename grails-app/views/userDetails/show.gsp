...
<html>
    ...
    <body>
        ...
        <div id="show-userDetails" class="content scaffold-show" role="main">
            ...
            <f:display bean="userDetails" />
            <g:form resource="${this.userDetails}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.userDetails}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
